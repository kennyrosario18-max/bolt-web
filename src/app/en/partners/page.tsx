...
export const metadata: Metadata = {
  ...
  description:
    "Fixed partner rate all year, monthly e-CF invoicing with no per-booking deposit, priority availability and per-villa reporting. Join the BOLT Partner Program in Punta Cana.",

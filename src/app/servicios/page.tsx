...
export const metadata: Metadata = {
  ...
  description:
    "Renta de golf carts por día, semana o temporada; venta de unidades nuevas con garantía; entrega a domicilio y programa de aliados para concierges y property managers en Punta Cana.",
};
